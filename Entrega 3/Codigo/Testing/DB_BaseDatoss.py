...
class DatabaseSingleton:
    ...
    def consult_table(self, consult):
        pass
    
    def update_table(self,consult):
        pass
    
    def selec_table(self, consult):
        pass
# Uso de la clase DatabaseSingleton para crear la base de datos y conexión

# Crear una instancia de la base de datos
db_instance = DatabaseSingleton("base_de_datos.db")

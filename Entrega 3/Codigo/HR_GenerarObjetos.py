...
def generarObjetos():
    ...
    for pais in paises:
        for provincia in provincias:
            if provincia._pais == pais:
                pais._provincias.append(provincia)
    ...
    for region in regiones:
        for provincia in provincias:
            if region._provincia == provincia:
                provincia._regiones.append(region)
    """
    for region in regiones:
    ...
    for bodega in bodegas:
        for region in regiones:
            if bodega._region == region:
                region._bodegas.append(bodega)
    """
    for bodega in bodegas:
    ...
    for resenia in resenias:
        resenia._fechaResenia = datetime.strptime(resenia._fechaResenia, date_format).date()
        
        #if resenia._esPremium:
        #    #print(resenia._fechaResenia)
    ...
    return (vinos, list(paises))


if __name__ == '__main__':
    vinos = generarObjetos()
